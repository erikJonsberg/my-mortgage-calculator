jQuery(function($) {
    ...
    $('#btnReset').click(function() {
        $('#txtValue, #txtDown, #txtLoan').val('');
        document.getElementById('interest-total').innerHTML = '';
        document.getElementById('repayment-value').innerHTML = '';
    })
});